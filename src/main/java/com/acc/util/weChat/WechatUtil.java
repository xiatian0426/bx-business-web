...
public class WechatUtil {
     ...
     * @return
     */
    public static Map<String,String> getOpenIdAndSessionKey(String code,String appId,String appSecret) {
     ...
     * @return
     */
    public static String getDDToken(String appId,String appSecret){
    ...
    public static Integer checkImg(String access_token,MultipartFile multipartFile) {
            try {
                ...
                request.addHeader("BxContent-Type", "application/octet-stream");
